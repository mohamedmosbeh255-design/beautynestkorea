...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${siteBaseUrl()}/affiliate-disclosure` },
};

// Canonical affiliate-disclosure URL (linked from the footer). The legacy
// /disclosure route renders the same policy; this page is the canonical home.
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl leading-relaxed text-ink-soft">
        Last updated: {new Date().getFullYear()} — {AFFILIATE_DISCLOSURE_TEXT}
      </p>
